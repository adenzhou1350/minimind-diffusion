...
def main():
    # ========== 1. 初始化环境和随机种子 ==========
    parser = argparse.ArgumentParser(description='minimind-diffusion-v Stage 2 SFT')
    ...
    parser.add_argument('--skip', type=int, default=0, help='跳过前 N 个 accum step 续训(配合 --from_weight vlm_sft)')
    ...
    sampler = SkipBatchSampler(ds, args.batch_size, skip=args.skip)
